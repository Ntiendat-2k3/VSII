 ...
 * CSS Custom Properties in styles.css are the primary source of truth.
 * These constants are kept for JS-level references (e.g. framer-motion, inline computations).
 */
